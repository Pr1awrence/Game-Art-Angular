...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    'of the game is located in the region between Sasau and Rattay.',
    genre: [Genre.RPG],
  ...
  },
  {
    ...
    longDescription: 'Minecraft is a 2011 sandbox video. The game allows players to build with a variety of different blocks in a ' +
    '3D procedurally generated world, requiring creativity from players. Other activities in the game include exploration, ' +
  ...
  },
  {
    ...
    longDescription: 'The game is played from either a third-person or first-person perspective and its world is navigated on foot ' +
  ...
  },
  {
    ...
    shortDescription: 'Action RPG from Bethesda Game Studios',
    longDescription: 'The game\'s main story revolves around the player character\'s quest to defeat Alduin the World-Eater, a dragon ' +
    'who is prophesied to destroy the world. The game is set 200 years after the events of Oblivion and takes place in Skyrim, ' +
    'the northernmost province of Tamriel. Over the course of the game, the player completes quests and develops ' +
